...
<template>
  ...
  >
    ...
    <template v-else-if="name === 'help'">
      ...
      <path d="M9.6 9a2.6 2.6 0 1 1 4.2 2c-.9.7-1.8 1.2-1.8 2.5" />
      <path d="M12 17h.01" />
    </template>
    ...
    <template v-else-if="name === 'chart'">
      <path d="M4 20h16" />
      <path d="M6 17v-5M10 17V8M14 17v-3M18 17V5" />
      <path d="m5 10 5-4 4 3 5-6" />
    </template>
    ...
    <template v-else-if="name === 'bar-chart'">
      <path d="M4 20h16" />
      <path d="M6 16v-4M10 16V6M14 16v-6M18 16V4" />
    </template>
